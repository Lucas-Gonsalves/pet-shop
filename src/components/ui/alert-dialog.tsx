...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        'bg-background-tertiary data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] fixed top-[50%] left-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border-none p-6 shadow-lg duration-200',
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ...
    className={cn(
      ...
      'text-label-medium h-10 rounded-lg px-6',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    className={cn(
      ...
      'text-label-medium mt-2 h-10 rounded-lg px-6 sm:mt-0',
      className,
    )}
    {...props}
  />
